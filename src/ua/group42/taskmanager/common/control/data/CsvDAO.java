...
import ua.group42.taskmanager.common.model.TaskComparator;
import ua.group42.taskmanager.common.tools.CSVTable;
...
public final class CsvDAO implements TaskDAO {
    ...
    public Collection<Task> loadTasks() {
        ...
        try {
            ...
            log.error("Tasks wasn't loaded, IO errors occured", ex);
            throw new InternalControllerException("Tasks wasn't loaded, IO  errors occured", ex);
        }
        return loadedTasks;
    }
}
