...
public class NetProtocol {
    ...
    public static final int INVALID_PARAMETR_ERROR = 1;
    public static final int CANNOT_PROVIDE_ACTION_ERROR = 2;
    public static final int WRONG_LOGIN_NAME_ERROR = 3;
    public static final int SERVER_STOPPED_ERROR = 4;
    public static final int WRONG_PARAMETRS_ERROR = 5;
