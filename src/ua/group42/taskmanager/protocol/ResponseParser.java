    ...
    private static final Logger log = Logger.getLogger(ResponseParser.class);
        ...
        private void parse() throws ParseException {
            if (msg.getDoc().getRootElement().getChild("fault") == null)
            {
                ...
                List<Element> members = msg.getDoc().getRootElement().getChild("fault").getChild("value").getChildren("struct");
                for (Element member : members) {
                    ...
                    if (member.getChildTextTrim("name").equalsIgnoreCase("faultString"))
                    {
